...
pub enum FormatDialect {
    ...
    ProTracker,
    /// Noisetracker and the ProTracker 3.x family — `M&K!`, `N.T.`, `LARD`, `NSMS`,
    /// `.M.K`. Played as ProTracker; recorded separately because libxmp's own timing
    /// heuristics key off it and M5 may need to.
    ProTracker3,
    /// Atari Octalyser — `CD61`, `CD81`.
    Octalyser,
    /// Atari Digital Tracker — `FA04`, `FA06`, `FA08`.
