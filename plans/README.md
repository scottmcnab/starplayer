...
| M7 DSP graph | **In progress** — pulled 2026-09-05; [H1](engine/complete/M7-task-H1-channel-buses-and-insert-graph.md) buses and the `Insert` trait and [H2](engine/complete/M7-task-H2-dsp-primitives.md) the DSP primitives landed; H3–H7 per the master plan | [M7](engine/M7-master-plan.md) | Per-channel inserts, master bus, SIMD |
