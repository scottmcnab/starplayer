...
| M8 Embedded proof | **Landed 2026-09-11; A1S audio accepted 2026-09-14** — all six original tasks and [I3a](engine/complete/M8-task-I3a-dma-refill-remediation.md) are in `engine/complete/`. [I1](engine/complete/M8-task-I1-embedded-host-core.md) provides `starplayer-host-embedded`; [I2](engine/complete/M8-task-I2-flash-resident-modules.md) provides borrowed PCM and `SPMI`; [I3](engine/complete/M8-task-I3-esp32-a1s-bringup.md) brought up ES8388/I2S; [I4](engine/complete/M8-task-I4-esp32-c5-riscv-bench.md) adds the C5 bench; [I5](engine/complete/M8-task-I5-buttons-and-display.md) adds keys/ST7789; [I6](engine/complete/M8-task-I6-web-control.md) adds captive portal, API and upload. The normal 48 kHz A1S image passed its objective soak and owner listening acceptance. Remaining UI and other-track checks follow `embedded/README.md` | [M8](engine/M8-master-plan.md) | ESP32-A1S (Xtensa) through the ES8388; the C5 proves RISC-V; `embedded/` is its own workspace on `esp-1.97` |
...
| M8 follow-up: RFC2217 flash wrapper | **Complete 2026-09-14** — [I7](engine/complete/M8-task-I7-rfc2217-flash-script.md). The executable `embedded/flash_image.sh` builds the fixed A1S `web` merged image and flashes it through the proven Mac RFC2217 bridge, with endpoint and baud overrides. Syntax, executable-bit and diff checks passed; the wrapper itself was not executed during implementation | [M8](engine/M8-master-plan.md) | Uses xtask's `--skip-padding` merged image; no erase or monitor step |
