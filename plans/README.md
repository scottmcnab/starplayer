...
| M3 Native surfaces | **Partly landed** — [D1](engine/complete/M3-task-D1-song-timeline-and-loop-detection.md) song timeline and [D2](engine/complete/M3-task-D2-natural-end-versus-loop.md) natural end versus loop pulled forward for the web player; the rest not started | [M3](engine/M3-master-plan.md) | cpal host, CLI, offline renderer, telemetry split |
