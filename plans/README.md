...
| M8 follow-up: DMA refill remediation | **Open — transport and gain-staged boot accepted 2026-09-14; owner listening pending** — [I3a](engine/M8-task-I3a-dma-refill-remediation.md). The 310-second transport soak sustained 176 400 B/s; the gain-staged fresh boot then advanced cleanly through its first five telemetry lines with no underruns and one stable recovered startup DMA error | [M8](engine/M8-master-plan.md) | Verified engine cap 1/4, headphone analog −12 dB, speaker pair minimum and PA off; clean stereo and left/right identity remain pending |
