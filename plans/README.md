...
| M2 MOD + MTM native, accuracy machinery | **In progress** — [C1](engine/complete/M2-task-C1-trace-format.md) trace format/differ, [C2](engine/complete/M2-task-C2-conformance-harness.md) pinned conformance harness, and [C6](engine/complete/M2-task-C6-fixed-point-mixer.md) canonical fixed-point goldens landed | [M2](engine/M2-master-plan.md) | C3–C5 and C7 remain; [C8](engine/M2-task-C8-dos-reference-harness.md) is **deferred** with an explicit trigger |
