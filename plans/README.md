...
| M8 follow-up: DMA refill remediation | **Open — swapped-tone discriminator objectively accepted; owner playing/stopped result and normal music pending** — [I3a](engine/M8-task-I3a-dma-refill-remediation.md). The 172 Hz descriptor-coherent tone was clean while engine and matched 125 Hz tones buzzed. The flashed `swapped-tone` image preserved the accepted transport, exchanged the 4 796/5 327 left/right peaks exactly and passed its boot, cadence and native-loop checks; owner listening will distinguish numeric level from the physical channel | [M8](engine/M8-master-plan.md) | Six quanta, three equal 2 048-byte descriptors; engine cap 1/4, headphone analog −12 dB, routing unchanged |
