...
| M8 Embedded proof | **Landed 2026-09-11; A1S audio and captive-portal boot accepted 2026-09-14** — all six original tasks and follow-ups I3a/I7/I7a/I8/I8a are in `engine/complete/`. [I1](engine/complete/M8-task-I1-embedded-host-core.md) provides `starplayer-host-embedded`; [I2](engine/complete/M8-task-I2-flash-resident-modules.md) provides borrowed PCM and `SPMI`; [I3](engine/complete/M8-task-I3-esp32-a1s-bringup.md) brought up ES8388/I2S; [I4](engine/complete/M8-task-I4-esp32-c5-riscv-bench.md) adds the C5 bench; [I5](engine/complete/M8-task-I5-buttons-and-display.md) adds keys/ST7789; [I6](engine/complete/M8-task-I6-web-control.md) adds captive portal, API and upload. The normal 48 kHz image passed its objective soak and owner listening acceptance; the web image reaches `StarPlayer-D3E4` with zero underruns. Remaining UI and other-track checks follow `embedded/README.md` | [M8](engine/M8-master-plan.md) | ESP32-A1S (Xtensa) through the ES8388; the C5 proves RISC-V; `embedded/` is its own workspace on `esp-1.97` |
...
| M8 follow-up: web boot RAM | **Complete 2026-09-14** — [I8](engine/complete/M8-task-I8-web-boot-stack-remediation.md) and [I8a](engine/complete/M8-task-I8a-web-internal-heap-remediation.md). Picoserve futures moved to claim-only PSRAM; internal heap is 144 KiB and core-0 stack is 57 564 B. Hardware reached the captive portal with 22 148 heap bytes free and sustained 43 seconds with zero underruns | [M8](engine/M8-master-plan.md) | Portal `StarPlayer-D3E4` at `http://192.168.4.1/`; PSRAM remains outside the global allocator |
