...
| M4 Generalise to a synthesis engine | **Split** — M4-lite in progress: [E1](engine/M4-task-E1-instrument-and-sample-model.md) instrument/sample model, [E2](engine/M4-task-E2-linear-frequency-and-format-dialects.md) linear-frequency table and dialects, [E3](engine/M4-task-E3-voice-lifecycle-and-trace-v2.md) voice lifecycle and trace v2; M4-full (MIDI, `Instrument` trait) deferred | [M4](engine/M4-master-plan.md) | Shared machinery for XM/IT, no `Instrument` trait until the MIDI sample player exists (owner, 2026-09-03) |
