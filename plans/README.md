...
| M8 follow-up: DMA refill remediation | **Open — transport accepted 2026-09-14; owner listening pending** — [I3a](engine/M8-task-I3a-dma-refill-remediation.md). A 310-second fresh-reset soak sustained the required 176 400 B/s with engine time tracking wall time, no underruns and one recovered startup DMA error that did not recur | [M8](engine/M8-master-plan.md) | Nine quanta, three equal 1 536-byte descriptors; headphone-only routing at 1/16 volume with speaker PA off |
