...
| M8 follow-up: DMA refill remediation | **Open** 2026-09-14 — [I3a](engine/M8-task-I3a-dma-refill-remediation.md). The refill task can wedge at start-up so the board never plays; diagnosed on an A1S by `../star-fx` and recorded in [embedded-budget.md](reference/embedded-budget.md) §4a. Read that before the first flash | [M8](engine/M8-master-plan.md) | Silence with `underruns=0` is the symptom |
