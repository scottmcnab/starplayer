...
| M4 Generalise to a synthesis engine | M4-lite **landed** 2026-09-03; M4-full **implemented** 2026-09-04, review and owner hardware jam check pending — [E4](engine/complete/M4-task-E4-instrument-and-midi-source.md) instruments and MIDI source, [E5](engine/complete/M4-task-E5-midi-codec-and-smf.md) codec and SMF, [E6](engine/complete/M4-task-E6-live-input.md) host input, [E7](engine/M4-task-E7-jam-mode.md) deterministic module-plus-live-input mux | [M4](engine/M4-master-plan.md) | `Player::jam`, native/web controls, six-block-size two-source collision proof, and 16-voice jam headroom are implemented. Owner MIDI-hardware acceptance remains |
