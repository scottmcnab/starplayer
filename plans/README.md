...
| M4 Generalise to a synthesis engine | M4-lite **landed** 2026-09-03 ([E1](engine/complete/M4-task-E1-instrument-and-sample-model.md), [E2](engine/complete/M4-task-E2-linear-frequency-and-format-dialects.md), [E3](engine/complete/M4-task-E3-voice-lifecycle-and-trace-v2.md)); M4-full **planned** 2026-09-04, not yet dispatched: [E4](engine/M4-task-E4-instrument-and-midi-source.md) `Instrument` trait, rack and MIDI source, [E5](engine/M4-task-E5-midi-codec-and-smf.md) codec and SMF, [E6](engine/M4-task-E6-live-input.md) live input, [E7](engine/M4-task-E7-jam-mode.md) jam mode | [M4](engine/M4-master-plan.md) | The trait gets its two implementations (`SampleInstrument`, `MappedInstrument`) in E4; MIDI-driven XM/IT articulation stays M11's |
