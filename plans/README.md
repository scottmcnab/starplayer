...
| M6 IT support | **In progress** — [G1](engine/M6-task-G1-it-loader.md) the IT loader (header, both instrument layouts, the IT 2.14/2.15 decompressor, the packed pattern format, `ItPatternData`) is the first task; G2–G6 follow per the [concurrency plan](engine/M3-M6-concurrency-plan.md) | [M6](engine/M6-master-plan.md) | NNA/DCT/DCA, voice stealing, resonant filter. The hardest format |
