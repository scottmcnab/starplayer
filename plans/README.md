...
| M8 follow-up: DMA refill remediation | **Open — 32-bit framing and cadence accepted 2026-09-14; owner listening pending** — [I3a](engine/M8-task-I3a-dma-refill-remediation.md). The merged image advanced engine time with wall time and wrote about 355.2 KB/s over a 10.01-second telemetry interval, consistent with the required 352 800 B/s; no underruns and one stable recovered startup DMA error | [M8](engine/M8-master-plan.md) | Six quanta, three equal 2 048-byte descriptors; engine cap 1/4, headphone analog −12 dB, routing and refill recovery unchanged |
