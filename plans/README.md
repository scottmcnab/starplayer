...
| M2 MOD + MTM native, accuracy machinery | **Next** — awaiting the owner's go | [M2](engine/M2-master-plan.md) | 8 task files ready, C1–C8. [C8](engine/M2-task-C8-dos-reference-harness.md) is **deferred** with an explicit trigger |
