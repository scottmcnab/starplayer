...
| M8 Embedded proof | **Pulled 2026-09-11** — task graph I1–I6 in the master plan, re-planned for the owner's hardware: [I1](engine/M8-task-I1-embedded-host-core.md) `no_std` host core, [I2](engine/M8-task-I2-flash-resident-modules.md) flash-resident modules, [I3](engine/M8-task-I3-esp32-a1s-bringup.md) ESP32-A1S bring-up (the exit criterion), then [I4](engine/M8-task-I4-esp32-c5-riscv-bench.md) ESP32-C5 RISC-V bench, [I5](engine/M8-task-I5-buttons-and-display.md) keys and the ST7789 (`lcd` feature), [I6](engine/M8-task-I6-web-control.md) captive portal and web control | [M8](engine/M8-master-plan.md) | Xtensa ESP32-A1S through the ES8388 first; the C5 proves RISC-V; `embedded/` is its own workspace |
