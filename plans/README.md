...
| M8 Embedded proof | **Landed 2026-09-11; A1S audio accepted 2026-09-14; portal phone acceptance pending** — all six original tasks and follow-ups I3a/I7/I7a/I8/I8a/I8b are in `engine/complete/`. [I1](engine/complete/M8-task-I1-embedded-host-core.md) provides `starplayer-host-embedded`; [I2](engine/complete/M8-task-I2-flash-resident-modules.md) provides borrowed PCM and `SPMI`; [I3](engine/complete/M8-task-I3-esp32-a1s-bringup.md) brought up ES8388/I2S; [I4](engine/complete/M8-task-I4-esp32-c5-riscv-bench.md) adds the C5 bench; [I5](engine/complete/M8-task-I5-buttons-and-display.md) adds keys/ST7789; [I6](engine/complete/M8-task-I6-web-control.md) adds captive portal, API and upload. The normal 48 kHz image passed its objective soak and owner listening acceptance; the web image announces `StarPlayer-D3E4` with zero underruns; I8b fixes premature radio shutdown after that announcement. Remaining UI and other-track checks follow `embedded/README.md` | [M8](engine/M8-master-plan.md) | ESP32-A1S (Xtensa) through the ES8388; the C5 proves RISC-V; `embedded/` is its own workspace on `esp-1.97` |
...
| M8 follow-up: portal controller lifetime | **Landed 2026-09-15; owner acceptance pending** — [I8b](engine/complete/M8-task-I8b-portal-controller-lifetime.md) retains the Wi-Fi controller in the AP network task so startup returning cannot shut down the radio. Both web builds pass with over 32 KiB stack | [M8](engine/M8-master-plan.md) | Phone visibility, joining, portal and save/reboot acceptance pending |
