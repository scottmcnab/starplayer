...
| M1 S3M in the browser | **In progress** — B1, B2, B3, B5 landed; B6 in flight; B4 next | [M1](engine/M1-master-plan.md) | 7 task files ready, B1–B7. [B4](engine/M1-task-B4-s3m-effects.md) is the accuracy core and the largest single task. Exit: **a real `.s3m` plays in a browser** |
