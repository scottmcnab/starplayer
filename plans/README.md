...
| M10 Alternative synths | **Planned** 2026-09-05 — task graph K1–K6 in the master plan; pull-driven, each item independent. **K5 pulled 2026-09-09**: [K5a](engine/complete/M10-task-K5a-enhancer-core.md) landed 2026-09-09, [K5b](engine/complete/M10-task-K5b-enhance-offline-and-cli.md) landed 2026-09-09 and [W4](apps/W4-task-enhancement-checkboxes.md) | [M10](engine/M10-master-plan.md) | Wavetable, FM, SoundFont, SID; sample-enhancement API |
...
| Sample-enhancement checkboxes | **Planned** 2026-09-09 — after K5a | [W4](apps/W4-task-enhancement-checkboxes.md) | Upsample (4× sinc) and loop-seam smoothing applied when a track is loaded, built from a wasm-exported catalogue |
