...
|---|---|---|---|
| [B1](M1-task-B1-module-model.md) | `Module` blob-and-offsets layout, samples, instruments | M0-A2 | B5 |
| [B2](M1-task-B2-s3m-loader.md) | S3M parsing: header, parapointers, patterns, samples, panning | B1 | B3, B5 |
| [B3](M1-task-B3-engine-render-loop.md) | Render loop, `RowClock`, sources, command queue, channel binding | M0-A3 | B2, B5 |
