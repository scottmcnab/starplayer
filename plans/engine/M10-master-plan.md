...
| K5 | The sample-enhancement API — pulled 2026-09-09 as [K5a](complete/M10-task-K5a-enhancer-core.md) (trait, rebuild, playback scale, `starplayer-enhance`; Opus; **landed**), [K5b](M10-task-K5b-enhance-offline-and-cli.md) (CLI/offline; Sonnet) and [W4](../apps/W4-task-enhancement-checkboxes.md) (web checkboxes; Sonnet); [original text](M10-task-K5-sample-enhancement.md) | — | K1, K2 | Opus / Sonnet |
