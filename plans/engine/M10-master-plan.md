...
| K5 | The sample-enhancement API — pulled 2026-09-09 as [K5a](complete/M10-task-K5a-enhancer-core.md) (trait, rebuild, playback scale, `starplayer-enhance`; Opus; **landed**), [K5b](complete/M10-task-K5b-enhance-offline-and-cli.md) (CLI/offline; Sonnet) and [W4](../apps/complete/W4-task-enhancement-checkboxes.md) (web checkboxes; Sonnet); [original text](M10-task-K5-sample-enhancement.md); [K5c](complete/M10-task-K5c-measure-sbr-denoise.md) (landed 2026-09-10) adds the measurement harness, bandwidth extension and decay denoising | — | K1, K2 | Opus / Sonnet |
