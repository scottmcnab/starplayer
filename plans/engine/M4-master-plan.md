...
| [E6](complete/M4-task-E6-live-input.md) | `Player::send_event`; `midir` input on the cpal host and the CLI's `--midi`; Web MIDI and the tracker-style keyboard map in the web player through a new ring opcode | E4 | Opus |
