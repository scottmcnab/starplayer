...
Each maps to a `PatternFlow` — fifteen named booleans whose meanings are libxmp's
...
disagreements about Scream Tracker 3, and D40 is a disagreement between the original and
both secondary oracles that no available reference can settle. The rest record deliberate
...
`plans/engine/M2-task-C5-quirks-and-tempo-models.md`; §2's *Tracker dialects* section
